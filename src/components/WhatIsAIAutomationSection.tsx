...
import { Bot, Zap, Repeat, BrainCircuit, Workflow, CheckCircle } from "lucide-react";
...
const WhatIsAIAutomationSection = () => (
  <>
    {/* What is AI Automation - Core Concepts */}
...
export default WhatIsAIAutomationSection;
