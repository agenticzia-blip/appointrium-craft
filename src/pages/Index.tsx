    ...
    <div>
        ...
        <div className="container-narrow text-center">
          <ScrollReveal>
            <h2 className="text-3xl md:text-4xl font-display font-bold mb-4">
              What You Learn About <span className="serif-italic text-gradient">AI Automation</span><span className="text-gradient">?</span>
            </h2>
      ...
      <section className="section-padding text-center">
        <div className="container-narrow">
          <ScrollReveal>
            <h2 className="text-3xl md:text-4xl font-display font-bold mb-4">
              Ready to <span className="serif-italic text-gradient">Start</span><span className="text-gradient">?</span>
            </h2>
