  ...
  <div>
    <section className="section-padding pt-32 text-center">
      <div className="container-narrow">
        <ScrollReveal>
          <p className="text-sm uppercase tracking-[0.3em] text-muted-foreground mb-4 font-display">Pricing</p>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold leading-tight mb-4">
            Invest in Your <span className="serif-italic text-gradient">Future</span>
          </h1>
